...
import { Drawer, DrawerTitle, DrawerHeader, DrawerContent, DrawerFooter, DrawerTrigger, DrawerDescription } from "@/components/ui/drawer";
            ...
            <DropdownMenuContent className="w-72" align="end" side="right">
                <DropdownMenuLabel>
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-sm font-normal text-muted-foreground turncate">{data.user.email}</span>
                    </div>
                </DropdownMenuLabel>
